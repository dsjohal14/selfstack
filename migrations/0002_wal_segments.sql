...
-- Segment types: 'wal' for live WAL segments, 'cmp' for compacted segments
-- Segment status lifecycle: active -> sealed -> compacting -> archived
CREATE TABLE wal_segments (
    id              BIGSERIAL PRIMARY KEY,
    segment_id      BIGINT NOT NULL,
    segment_type    TEXT NOT NULL DEFAULT 'wal',
    ...
    CONSTRAINT valid_segment_type CHECK (segment_type IN ('wal', 'cmp')),
    CONSTRAINT unique_segment_type_id UNIQUE (segment_type, segment_id)
);
